...
const ZH: Record<string, string> = {
  ...
  "Latest papers": "最新论文",
  "New models": "新模型",
  "New benchmarks": "新评测基准",
  "New datasets": "新数据集",
  "Featured tools": "精选工具",
  "All →": "全部 →",
  "Browse the hub": "浏览资源中心",
  "Latest trustworthy AI news, in your inbox": "每日可信人工智能资讯，发送到你的邮箱",
  "New papers, model releases, benchmarks, and datasets — collected from popular media accounts and sent as a daily digest. Pick the language you read in.":
    "汇集热门媒体账号中的新论文、模型发布、评测基准和数据集，每日整理发送。请选择阅读语言。",
  "Digest language": "简报语言",
  "Email address": "邮箱地址",
  Subscribe: "订阅",
  "Subscribing...": "正在订阅……",
  "Signup is not connected yet — set newsletter.endpoint in src/data/site.ts.":
    "订阅功能尚未接通——需要在数据生成源中配置 newsletter.endpoint。",
  "Check your inbox to confirm the subscription.": "请查收邮件并确认订阅。",
  "Something went wrong. Please try again.": "出现错误，请重试。",
  "One email a day. Unsubscribe any time.": "每天一封，可随时退订。",
  Entries: "条目",
  Categories: "分类",
...
const ZH_CONTENT: Record<string, string> = {
  "Safety benchmarks across LLMs, Agents, and Embodied AI, extracted from the two source lists and their linked survey manuscripts.":
    "覆盖大语言模型、智能体与具身智能安全的评测基准，均提取自两份指定来源清单及其关联综述。",
